...
export const isLandscapeMobile = staticW > staticH && staticW < 1024;
...
export const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: isLandscapeMobile ? 10 : 16, paddingVertical: isLandscapeMobile ? 2 : 8, borderBottomWidth: 1, borderBottomColor: 'rgba(232,217,176,0.1)' },
  ...
  opponentsRow: { flexDirection: 'row', paddingHorizontal: isLandscapeMobile ? 4 : 8, paddingVertical: isLandscapeMobile ? 1 : 10, gap: isLandscapeMobile ? 3 : 6 },
  aiBadge: { flex: 1, backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: isLandscapeMobile ? 6 : 10, padding: isLandscapeMobile ? 3 : 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)', position: 'relative' },
  ...
  aiCardCountText: { fontSize: isLandscapeMobile ? 12 : 18, fontWeight: '700', color: 'rgba(255,255,255,0.8)' },
  ...
  statusBar: { paddingHorizontal: isLandscapeMobile ? 10 : 16, paddingVertical: isLandscapeMobile ? 2 : 4 },
  statusText: { fontSize: isLandscapeMobile ? 10 : 11, color: 'rgba(232,217,176,0.5)', textAlign: 'center' },
  ...
  humanArea: { paddingBottom: isLandscapeMobile ? 4 : 20, borderTopWidth: 1, borderTopColor: 'rgba(232,217,176,0.1)', overflow: 'visible' as any },
  humanHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: isLandscapeMobile ? 8 : 16, paddingVertical: isLandscapeMobile ? 1 : 8 },
  ...
  actionBtn: { paddingHorizontal: isLandscapeMobile ? 10 : 16, paddingVertical: isLandscapeMobile ? 5 : 8, borderRadius: 20, minWidth: isLandscapeMobile ? 44 : 60, alignItems: 'center' },
