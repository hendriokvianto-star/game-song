...
export const getResponsiveCardSize = (compact: boolean, screenW: number, screenH: number) => {
  ...
  if (isLandscape) {
    // Make cards occupy ~18% of screen height in compact mode (good for tables)
    // and ~23% in normal mode.
    const h = compact ? Math.max(42, screenH * 0.18) : Math.max(54, screenH * 0.23);
...
export const styles = StyleSheet.create({
  ...
  header: { 
    ...
    paddingHorizontal: isLandscapeMobile ? 10 : 16, paddingVertical: isLandscapeMobile ? 0 : 10, 
    borderBottomWidth: 1.5, borderBottomColor: 'rgba(232,217,176,0.15)',
    backgroundColor: 'rgba(0,0,0,0.2)',
  },
  headerTitle: { fontSize: isLandscapeMobile ? 12 : 18, fontWeight: '900', color: '#E8D9B0', letterSpacing: isLandscapeMobile ? 1 : 3 },
  headerRight: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  seqCount: { fontSize: 12, color: 'rgba(232,217,176,0.7)', backgroundColor: 'rgba(232,217,176,0.1)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, borderWidth: 1, borderColor: 'rgba(232,217,176,0.08)' },
  openLogBtn: { backgroundColor: 'rgba(255,255,255,0.08)', paddingHorizontal: 14, paddingVertical: 7, borderRadius: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  ...
  aiBadge: { 
    ...
    borderRadius: isLandscapeMobile ? 4 : 12, 
    padding: isLandscapeMobile ? 2 : 10, 
    borderWidth: 1, 
    borderColor: 'rgba(255,255,255,0.08)', 
    position: 'relative',
    ...Platform.select({
      default: { shadowColor: 'rgba(0,0,0,0.3)', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4 },
      web: {} as any,
    }),
  },
  aiBadgeActive: { 
    ...
    borderWidth: 1.5,
    ...Platform.select({
      default: { shadowColor: '#f1c40f', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.25, shadowRadius: 8 },
      web: {} as any,
    }),
  },
  aiBadgeFinished: { opacity: 0.4 },
  aiBadgeHeader: { flexDirection: 'row', alignItems: 'center', gap: isLandscapeMobile ? 2 : 4, marginBottom: isLandscapeMobile ? 1 : 4 },
  aiEmoji: { fontSize: isLandscapeMobile ? 10 : 14 },
  aiName: { fontSize: isLandscapeMobile ? 9 : 11, fontWeight: '700', color: 'rgba(255,255,255,0.55)', flexShrink: 1 },
  aiNameActive: { color: '#f1c40f' },
  aiCardCount: { flexDirection: 'row', alignItems: 'baseline', gap: isLandscapeMobile ? 2 : 3 },
  aiCardCountText: { fontSize: isLandscapeMobile ? 10 : 20, fontWeight: '800', color: 'rgba(255,255,255,0.85)' },
  ...
  aiScoreBadge: { 
    position: 'absolute', bottom: isLandscapeMobile ? -2 : -6, right: isLandscapeMobile ? -2 : -6, 
    backgroundColor: 'rgba(15,31,21,0.95)', 
    paddingHorizontal: isLandscapeMobile ? 4 : 7, paddingVertical: isLandscapeMobile ? 1 : 3, 
    borderRadius: 10, borderWidth: 1, borderColor: 'rgba(232,217,176,0.25)' 
  },
  ...
  tableArea: { 
    flex: 1, 
    marginHorizontal: isLandscapeMobile ? 2 : 6, 
    marginVertical: isLandscapeMobile ? 0 : 4,
    borderRadius: isLandscapeMobile ? 10 : 20, 
    borderWidth: 1.5, 
    overflow: 'hidden',
    ...Platform.select({
      default: { shadowColor: 'rgba(0,0,0,0.5)', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.5, shadowRadius: 12 },
      web: {} as any,
    }),
  },
  ...
  humanArea: { 
    paddingBottom: isLandscapeMobile ? 0 : 20, 
    borderTopWidth: 1.5, 
    borderTopColor: 'rgba(232,217,176,0.12)', 
    overflow: 'visible' as any,
    backgroundColor: 'rgba(0,0,0,0.15)',
  },
  humanHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: isLandscapeMobile ? 6 : 16, paddingVertical: isLandscapeMobile ? 0 : 10 },
  humanInfo: { flexDirection: 'row', alignItems: 'center', gap: isLandscapeMobile ? 4 : 8 },
  humanName: { color: 'rgba(255,255,255,0.7)', fontWeight: '700', fontSize: isLandscapeMobile ? 11 : 15 },
  humanNameActive: { color: '#E8D9B0' },
  humanScoreBadge: { backgroundColor: 'rgba(232,217,176,0.1)', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 14, borderWidth: 1, borderColor: 'rgba(232,217,176,0.08)' },
  humanScoreText: { color: '#E8D9B0', fontSize: 12, fontWeight: 'bold' },
  yourTurnBadge: { 
    fontSize: 9, fontWeight: '900', color: '#0F1F15', 
    backgroundColor: '#f1c40f', 
    paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6,
    overflow: 'hidden',
  },
  actionButtons: { flexDirection: 'row', gap: isLandscapeMobile ? 4 : 10 },
  actionBtn: { 
    paddingHorizontal: isLandscapeMobile ? 8 : 20, 
    paddingVertical: isLandscapeMobile ? 3 : 11, 
    borderRadius: isLandscapeMobile ? 12 : 22, 
    minWidth: isLandscapeMobile ? 40 : 76, 
    alignItems: 'center',
    ...Platform.select({
      default: { shadowColor: 'rgba(0,0,0,0.4)', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.4, shadowRadius: 4 },
      web: {} as any,
    }),
    elevation: 3,
  },
  actionBtnDisabled: { opacity: 0.3, elevation: 0 },
  passBtnStyle: { backgroundColor: 'rgba(231,76,60,0.25)', borderWidth: 1.5, borderColor: 'rgba(231,76,60,0.5)' },
  playBtnStyle: { backgroundColor: 'rgba(46,204,113,0.25)', borderWidth: 1.5, borderColor: 'rgba(46,204,113,0.5)' },
  actionBtnText: { color: 'white', fontWeight: '800', fontSize: isLandscapeMobile ? 11 : 15, letterSpacing: 0.5 },
  ...
  hintBtnStyle: { backgroundColor: 'rgba(241,196,15,0.2)', borderWidth: 1.5, borderColor: 'rgba(241,196,15,0.5)' },
  hintNotification: {
    position: 'absolute',
    top: 60,
    left: 20,
